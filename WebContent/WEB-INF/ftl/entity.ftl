		...
		<div class="contentContainer">
			<ul class="inheritance">
				...
				<li>
					...
					<ul class="inheritance">
						<li><#if ancestor.entityPath != ""><a href="javascript:;" onclick="changeNode('${ancestor.entityPath}.html')">${ancestor.qualifiedEntityName}</a><#else>${ancestor.qualifiedEntityName}</#if></li>
						<li>
					</#list>
					<#list entityHierarchy as ancestor>
						</li>
						...
						<ul class="blockList">
							<li class="blockList">
										...
										<tbody>
											...
											<#list attributes?sort_by("name") as attribute>
												...
												<tr class="<#if odd>altColor<#else>rowColor</#if>">
													<td class="colFirst"><code>${attribute.stereotypes}</code>&nbsp;<div class="block"><code><#if attribute.typePath?length gt 0><a href="javascript:;" onclick="changeNode('${attribute.typePath}.html')"></#if>${attribute.type}<#if attribute.typePath?length gt 0></a></#if>${attribute.cardinality}</code></div></td>
								...
								<#list inheritedAttributes as superClass>
									...
									<ul class="blockList">
										<li class="blockList">
											<h3>Attributes inherited from <a href="javascript:;" onclick="changeNode('${superClass.entityPath}.html')" title="${superClass.entityName}">${superClass.entityName}</a></h3>
											<#assign separator="">
						...
						<ul class="blockList">
							<li class="blockList">
									...
									<table class="overviewSummary" border="0" cellpadding="3" cellspacing="0" summary="Association Summary table, listing associations and an explanation">
										...
										<tbody>
											...
											<#list associations?sort_by("name") as association>
												<#assign odd=!odd>
												<tr class="<#if odd>altColor<#else>rowColor</#if>">
													<td class="colFirst"><code><#if association.typePath?length gt 0><a href="javascript:;" onclick="changeNode('${association.typePath}.html')"></#if>${association.type}<#if association.typePath?length gt 0></a></#if> ${association.cardinality}</code></td>
								...
								<#list inheritedAssociations as superClass>
									...
									<ul class="blockList">
										<li class="blockList">
											<h3>Associations inherited from <a href="javascript:;" onclick="changeNode('${superClass.entityPath}.html')" title="${superClass.entityName}">${superClass.entityName}</a></h3>
											<#assign separator="">
