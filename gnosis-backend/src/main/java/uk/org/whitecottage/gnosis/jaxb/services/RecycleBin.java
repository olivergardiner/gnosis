    ...
    implements Serializable
{
    ...
    protected List<Serializable> towerOrServiceComponentOrServiceElement;
     ...
     * 
     */
    public List<Serializable> getTowerOrServiceComponentOrServiceElement() {
        if (towerOrServiceComponentOrServiceElement == null) {
            towerOrServiceComponentOrServiceElement = new ArrayList<Serializable>();
        }
