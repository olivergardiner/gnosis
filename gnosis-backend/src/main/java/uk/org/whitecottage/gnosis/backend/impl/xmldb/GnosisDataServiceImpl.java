...
import uk.org.whitecottage.gnosis.backend.data.jaxb.ApplicationBeanJaxb;
...
public class GnosisDataServiceImpl extends GnosisDataService {
    ...
    private GnosisDataServiceImpl() {
    	...
    	persistenceManager = new PersistenceManager("xmldb:exist://localhost:8080/exist/xmlrpc", "/db/gnosis");
    }
    ...
    public synchronized List<ApplicationBean> getAllApplications() {
    	...
    	for (Application application: persistenceManager.getApplications()) {
    		applications.add(new ApplicationBeanJaxb(application));
    	}
...
*/
    ...
    public synchronized ApplicationBean getApplicationById(String applicationId) {
        ...
        return new ApplicationBeanJaxb(persistenceManager.getApplication(applicationId));
    }
